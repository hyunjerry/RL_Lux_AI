...
# model1
# model = torch.jit.load(f'{path}/model_1_15_epochs_accu_0.84_loss_0.43.pth')

# model3
# model = torch.jit.load(f'{path}/model_3_14_epochs_accu_0.82_loss_0.43.pth')

# AvgPool model
model = torch.jit.load(f'{path}/avgpool_model.pth')
